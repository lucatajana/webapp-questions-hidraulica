...
const questions = [
    { text: "In a fluid flowing through a horizontal pipe, the velocity is lower near the pipe walls than at the center.", answer: "V" },
    { text: "In a gravity dam, the value of the thrust on the upstream face is greater than the subpressure.", answer: "V" },
    { text: "The Reynolds number does not depend on the fluid's density.", answer: "F" },
    { text: "Cavitation in a pipe is related to very low pressures.", answer: "V" },
    { text: "If a pump is installed at the upstream end of a straight, constant-diameter pipe with no localized losses and positive h, it increases the risk of cavitation.", answer: "V" },
    { text: "The Coriolis coefficient deviates from 1 the less uniform the velocity distribution is inside the pipe.", answer: "V" },
    { text: "The required NPSH of a pump may determine its position within a pumping installation.", answer: "V" },
    { text: "Two reservoirs with free surfaces at the same elevation, connected by a pipe and without any pumping: their hydraulic gradient will be zero.", answer: "V" },
    { text: "A submersible pump cannot experience cavitation.", answer: "F" },
    { text: "An incompressible fluid is defined as one that maintains its density regardless of the pressure to which it is subjected.", answer: "V" },
    { text: "If the bulk modulus of elasticity of a liquid is E, then increasing its density by 0.1% would require increasing the pressure by 0.1% of E.", answer: "V" },
    { text: "In a constant-diameter pipe transporting water under steady flow, the power of the flow decreases along the pipe in the direction of the flow.", answer: "V" },
    { text: "The value of the NPSH imposes constraints on the placement of a pump to avoid cavitation.", answer: "V" },
    { text: "A very long channel has a step in its central part that increases the bed elevation in the direction of the flow. If the channel is of type M, the normal depth may exist immediately upstream of the step.", answer: "V" },
    { text: "Under normal conditions, the specific weight of air is zero.", answer: "F" },
    { text: "In a pipe with a pump supplying a power P and transporting a flow rate Q, if the pipe’s absolute roughness increases due to deterioration, it is possible for the pump to still deliver the same flow rate Q while consuming the same power P.", answer: "F" },
    { text: "The total energy head provided by two identical pumps operating in parallel is twice the head provided by each pump individually.", answer: "F" },
    { text: "A channel must be prismatic in order for uniform flow to occur.", answer: "V" },
    { text: "In an H-type channel, the flow may lose velocity downstream.", answer: "V" },
    { text: "HEC-RAS allows the characterization of any river cross-section using a single Manning coefficient.", answer: "V" },
    { text: "In a rectangular channel with non-zero velocity, the specific energy value is always greater than the flow depth.", answer: "V" },
    { text: "In the transition between a very long M-type channel and a very long S-type channel, without expansions, contractions, or changes in bed elevation, the flow depth will always be the critical depth.", answer: "V" },
    { text: "In a channel with an expansion in the direction of flow, and with very long upstream and downstream S-type sections, the flow depth immediately upstream of the expansion will always correspond to the uniform depth of the upstream section.", answer: "V" },
    { text: "The hydraulic jump produced in a transition from an S-type channel to an M-type channel in a prismatic channel can only occur in the S-type section.", answer: "V" },
    { text: "In an S1 profile, the Froude number tends toward 1 in the direction of motion.", answer: "F" },
    { text: "In the channel reach where uniform flow is achieved, the water surface elevation varies from section to section.", answer: "F" },
    { text: "Downstream from an undershot gate operating free (i.e., not submerged), the flow depth is less than the vertical opening of the gate.", answer: "V" },
    { text: "In open-channel flow, the discharge, flow depth, and hydraulic gradient are interdependent.", answer: "V" },
    { text: "The units of the Manning formula are energy per unit volume.", answer: "F" },
